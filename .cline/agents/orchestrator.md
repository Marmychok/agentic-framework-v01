...
*This markdown file lives in `.cline/agents/orchestrator.md` and serves as the contract for the master orchestrator component of the Cline Agentic Automation Platform.*