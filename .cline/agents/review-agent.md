...
*Suggested actions:* Rename files, replace duplicate logger calls with shared utility, add STOP before Execution Agent.
```

--- 

*File location:* `.cline/agents/review-agent.md`*