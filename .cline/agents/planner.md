...
{
  "steps": [
    { "agent": "FeatureGenerator", "subAgents": ["FeatureWriter","ScenarioWriter"], "inputs": { "featureName": "User Login" } },
    { "agent": "PageObjectGenerator", "subAgents": ["LocatorBuilder","MethodBuilder"], "inputs": { "pageName": "LoginPage" } },
    { "agent": "ComponentGenerator", "subAgents": ["ComponentWriter"], "inputs": { "components": ["Navbar","Footer"] } },
...
*File location:* `.cline/agents/planner.md`*