...
3. **Sub‑Agent Layer** – Specialized workers under each Major Agent (e.g., _Requirement Reader_, _Risk Analyzer_, _Accessibility Locator_). They generate granular artefacts.
